namespace UnityEngine.Rendering.Universal
{
    public class PostProcessUrp : ScriptableRendererFeature
    {
        ...
        {
            ppsUrpPass = new PostProcessUrpPass(settings.Event, settings.blitMaterial, settings.NumberOfPasses,
                settings.Blur, settings.BlurAmount, settings.BlurMask,
                settings.Bloom, settings.BloomColor, settings.BloomAmount, settings.BloomDiffuse, settings.BloomThreshold,
                settings.LUT, settings.LutDimension, settings.LutAmount, settings.SourceLut,
