...
public class AsteroidRing : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        this.orbitalAngularVelocity = OrbitalUtils.OrbitalVelocityToAngularVelocity(this.radius, OrbitalUtils.Vp(this.radius, this.radius, parentGravitySource.parameters.mass, parentGravitySource.constants.GravitationalConstant)) * Mathf.Rad2Deg * (this.reverseRotation? -1f : 1f);
